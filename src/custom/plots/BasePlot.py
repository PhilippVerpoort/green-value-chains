...
class BasePlot(AbstractPlot):
    ...
    def _addAnnotation(self, fig: go.Figure, col: int, text: str, row: int = 1):
        fig.add_annotation(
            ...
            showarrow=False,
            bordercolor='black',
            borderwidth=self._config['global']['lw_ultrathin'],
            borderpad=2*self._config['global']['lw_ultrathin'],
            bgcolor='white',
            row=row,
            col=col + 1,
        )
    ...
    def _addAnnotationComm(self, fig: go.Figure, col: int, comm: str):
        fig.add_annotation(
            ...
            yanchor='bottom',
            showarrow=False,
            bordercolor=self._config['commodity_colours'][comm],
            borderwidth=self._config['global']['lw_thin'],
