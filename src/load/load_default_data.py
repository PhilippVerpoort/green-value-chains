...
default_techdata = pd.read_csv(getFilePathInput('./data/technologies.csv')).astype({'val': 'float32', 'period': 'int32'}, errors='ignore')
default_prices = pd.read_csv(getFilePathInput('./data/prices.csv')).astype({'val': 'float32', 'period': 'int32'}, errors='ignore')
